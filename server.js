...
// 4> If you use express.json() it will parse the body from post/fetch request except from html post form. It won't parse information from the html post form (for that use express.urlencoded())
