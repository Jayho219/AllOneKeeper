...
forgetPasswordController.getForgetPassword = (req, res) => {
  res.render('password/forgetPassword', {
    layout: "../views/layouts/password", error: null });
};
...
forgetPasswordController.postForgetPassword = async (req, res) => {
  ...
  try {
    ...
    const transporter = nodemailer.createTransport({
        ...
        auth: {
          user: 'agraharia329@gmail.com', // Your email address
...
// Show the reset password form on click gmail link 
